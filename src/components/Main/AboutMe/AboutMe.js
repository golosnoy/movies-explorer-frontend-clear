            ...
            <div className='aboutme__container'>
                ...
                <div className='aboutme__info'>
                    <div className='aboutme__biography'>
                        <h3 className='aboutme__biography-name'>Виталий</h3>
                        <h4 className='aboutme__biography-specialization'>Фронтенд-разработчик, 30 лет</h4>
                        ...
                        <a href='https://github.com/golosnoy' className='aboutme__biography-link' target='_blank' rel='noreferrer'>Github</a>
                    </div>
